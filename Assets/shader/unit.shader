Shader "Custom/UnitShader" {
	Properties {
		...
		_LightConst("LightConst", Range(0.0, 3.0)) = 1.0
	}
	SubShader {
		Pass{
			...
			float4 frag( vertexOutput i ): COLOR {
				...
				float3 lightFinal = diffuseReflection + ( specularReflection * tex.a ) + rimLighting + UNITY_LIGHTMODEL_AMBIENT.rgb + (texE.xyz * _EmitStrength * _EmitColor) +(texE_2.xyz * _EmitStrength * _EmitColor_2);
				//lightFinal = tex.a;
