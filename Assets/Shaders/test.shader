Shader "2 Color Emitter Shader" {
	Properties {
		...
		_EmitMap_2 ("Emission Texture 2", 2D) = "black" {}
		_EmitStrength ("Emit Strength", Range( 0.0, 2.0 )) = 0
		_EmitColor( "Emit Color", Color ) = ( 0.0, 0.0, 0.0, 0.0 )
		_EmitColor_2( "Emit Color 2", Color ) = ( 0.0, 0.0, 0.0, 0.0 )
		_SpecColor( "Specular Color", Color ) = ( 1.0, 1.0, 1.0, 1.0 )
		_Shininess( "Shininess", float ) = 10
		_RimColor( "Rim Color", Color ) = ( 1.0, 1.0, 1.0, 1.0 )
		_RimPower( "Rim Power", Range( 0.1, 10.0 )) = 3.0
		_LightConst("LightConst", Range(0.0, 3.0)) = 3.0
	...
	SubShader {
		Pass{
			...
			uniform sampler2D _EmitMap_2;
			uniform sampler2D _EmitMap_3;
			uniform float4 _EmitMap_ST;
			uniform float4 _EmitMap2_ST;
			uniform float _EmitStrength;
			uniform float4 _EmitColor;
			uniform float4 _EmitColor_2;
			uniform float4 _SpecColor;
			uniform float _Shininess;
			uniform float4 _RimColor;
			uniform float _RimPower;
			uniform float _LightConst;
			uniform float _EmitConst_1;
			uniform float _EmitConst_2;
			...
			float4 frag( vertexOutput i ): COLOR {
				...
				float4 texE_2 = tex2D( _EmitMap_2, i.tex.xy * _EmitMap2_ST.xy + _EmitMap2_ST.zw );
				...
				//float glow = ( texE.xyz * _EmitStrength * _EmitColor.rgb);
				//float glow_2 = ( texE_2.xyz * _EmitStrength * _EmitColor_2);
				//float glow_3 = ( texE_3.xyz * _EmitStrength * _EmitColor_3);
				
				float3 lightFinal = (_DifRefConst * diffuseReflection) + (_SpecularConst * specularReflection * tex.a ) + rimLighting + UNITY_LIGHTMODEL_AMBIENT.rgb + (_EmitConst_1 * texE.xyz * _EmitStrength * _EmitColor) +(_EmitConst_2 * texE_2.xyz * _EmitStrength * _EmitColor_2);
				//lightFinal = tex.a;
				

				return float4(_LightConst * tex.xyz * lightFinal * _Color.xyz, 1.0);
			}
