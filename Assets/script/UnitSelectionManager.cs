...
public class UnitSelectionManager : MonoBehaviour
{
    ...
    private void unitSelection()
    {
        ...
        {
            if (hit.transform.gameObject.tag == "FriendlyUnitGroup" || hit.transform.gameObject.tag == "FriendlyUnit")
            {
                ...
                if (hit.transform.gameObject.tag == "FriendlyUnitGroup")
                {
                    SelectedUnitGroup = hit.transform.gameObject.GetComponent<UnitGroup>();
                }
                else // Add unit's group
                {
                    SelectedUnitGroup = hit.transform.gameObject.GetComponent<Unit>().getUnitGroup();
                }
            }
        }
    }
